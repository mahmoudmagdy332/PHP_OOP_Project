				...
				<div class="banner-top">
					<div class="overlay">
						<div class="container">
							...
							<!-- //nav -->
		<form class="searchbar" action="searchpage.php" method="post">
...
<section class="packages py-5">
	<div class="container py-lg-4 py-sm-3">
		...
		<div class="row">
                    ...
                    $u=new user();
                    $t=$u->veiwpackages();
                    //for($i=0;$i<$u->get_nomberpackage();$i++){
                    for($i=0;$i<4;$i++){
			echo "<div class='col-lg-3 col-sm-6'>".
				...
				"<div class='package-info'>".
					...
					"<h5 class='my-2'>".$t[$i]['Package_name']."</h5>".
					...
					"</ul>".
                        ...
                        "<input type='submit' class='linkToShowPackage'  name='submit'value='View Details'>".
